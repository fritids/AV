...
foreach ($a as $attribute) {
    ?>
            var mytr = $(this).closest('tr');
            mytr.find('.attributes<?= $attribute["id_attribute"] ?>').chained(mytr.find('.product'));
                        ...
                        <div class="tab-pane active" id="classique">
                            ...
                            <table class="table table-bordered table-condensed col-md-12" id="tab_devis">
                                ...
                                <td>
                                    ...
                                    $r = getAllProductInfo();
                                    ?>
                                    <select name="product_name[]" class="product" id="product">
                                        <?
                                                    ...
                                                    foreach ($product["combinations"] as $idc => $combination) {
                                                        if ($idc == $attribute["id_attribute"]) {
                                                            ...
                                                            foreach ($combination["attributes"] as $ida => $attribute) {
                                                                ?>
                                                                <option value = "<?= $ida ?>" class="<?= $product["id_product"] ?>"><?= $attribute["name"] ?></option>
                                                                <?
                                                            }
                                                        }
                                                    }
                                ...
                                <td><input type="text" name="product_unit_price[]" class="unit_price" size="5" /> €/m²</td>
...
foreach ($a as $attribute) {
    ?>
        $("#attributes<?= $attribute["id_attribute"] ?>").chained("#product");
    <?
}
?>
</script>
