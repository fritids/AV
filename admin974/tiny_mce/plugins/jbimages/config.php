...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = 'img/cms'; // Relative to domain name
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] ."allovitres/". $config['img_path']; // Physical path. [Usually works fine like this]
