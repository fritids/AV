<div id="identification">
    ...
    <div class="forms">
        <div class="creation form">
            ...
            <p class="">
                <a href="index.php?register" class="particulier">particulier</a>
                <a href="index.php?register" class="pro">Professionnel</a>
            </p>
        </div>
        <div class="login form">
            <form action="index.php?action=login" method="post">
                ...
                <div class="row">
                    ...
                    <input class="text" type="text" name="email" id="login">
                </div>
                <div class="row">
                    <label for="password">Mot de passe :</label>
                    <input class="text" type="password" name="passwd" id="password">
                </div>
                <p>
