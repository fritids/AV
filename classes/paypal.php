...
//=======================================================================//
    ...
    public function addSimpleItem($item) {
        if (//Check the quantity and the name
                !empty($item['quantity']) && is_numeric($item['quantity']) && $item['quantity'] > 0 && !empty($item['name'])
...
//https://www.sandbox.paypal.com/cgi-bin/webscr
       ...
       <input type="hidden" name="custom" value="' . $this->custom . '" />';
        ...
        $form.='
         <input id="ppcheckoutbtn" type="submit" value="Payer avec Paypal" class ="pay_paypal" />
       </form>';
